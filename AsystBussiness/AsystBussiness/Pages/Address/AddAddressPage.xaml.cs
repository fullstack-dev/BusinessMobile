    ...
    public partial class AddAddressPage : ContentPageBase
    {
        ...
        async void ButtonNext_Clicked(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    ExtendedAddress serviceAddress = new ExtendedAddress() { BasicAddress = new ColonyConcierge.APIData.Data.Address() };
                    ...
                    {
                        ExtendedAddress newServiceAddress = new ExtendedAddress() { BasicAddress = new ColonyConcierge.APIData.Data.Address() };
